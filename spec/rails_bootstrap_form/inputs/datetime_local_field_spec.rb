...
# spec/rails_bootstrap_form/inputs/datetime_local_field_spec.rb

require "spec_helper"

RSpec.describe RailsBootstrapForm::Inputs::DatetimeLocalField do
  let(:user) { ::User.new }
  ...
  describe "#datetime_local_field" do
    it "renders default Rails helper when bootstrap is disabled" do
      ...
      actual = form_builder.datetime_local_field :interview_datetime, bootstrap: {disabled: true}
    ...
    it "renders correctly in vertical layout" do
      ...
      actual = form_builder.datetime_local_field :interview_datetime
    ...
    it "renders correctly in inline layout" do
      ...
      actual = form_builder.datetime_local_field :interview_datetime, bootstrap: {layout: :inline}
    ...
    it "renders correctly in horizontal layout" do
      ...
      actual = form_builder.datetime_local_field :interview_datetime, bootstrap: {layout: :horizontal}
