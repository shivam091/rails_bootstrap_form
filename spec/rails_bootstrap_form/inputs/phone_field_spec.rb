...
# spec/rails_bootstrap_form/inputs/phone_field_spec.rb

require "spec_helper"

RSpec.describe RailsBootstrapForm::Inputs::PhoneField do
  let(:user) { ::User.new }
  ...
  describe "#phone_field" do
    it "renders default Rails helper when bootstrap is disabled" do
      ...
      actual = form_builder.phone_field :mobile_number, bootstrap: {disabled: true}
    ...
    it "renders correctly in vertical layout" do
      ...
      actual = form_builder.phone_field :mobile_number
    ...
    it "renders correctly in inline layout" do
      ...
      actual = form_builder.phone_field :mobile_number, bootstrap: {layout: :inline}
    ...
    it "renders correctly in horizontal layout" do
      ...
      actual = form_builder.phone_field :mobile_number, bootstrap: {layout: :horizontal}
